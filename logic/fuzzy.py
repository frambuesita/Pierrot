...
pierrot_potential['high'] = fuzz.trimf(pierrot_potential.universe, [60, 75, 91])
...
rival_danger['high'] = fuzz.trimf(rival_danger.universe, [60, 75, 91])
...
rule_high_highest = ctrl.Rule(pierrot_potential['high'] & rival_danger['highest'], bet['lowest'])
...
rule_highest_highest = ctrl.Rule(pierrot_potential['highest'] & rival_danger['highest'], bet['lowest']) 
